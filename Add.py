...
with tab2:
    ...
    #final_data=pd.read_excel(masterpath, sheet_name='NIFTY')
    if read_data!=None:
...
################ button logic
    if previous01 == True:
        ...
        #.apply(highlight_row, axis=1, subset=['STRIKE','CALL_LTP','PUT_LTP','PUT_VOL_Per','CHNG', 'CHNG.1','CALL_VOL_Per', 'CE_Price', 'PE_Price'])
